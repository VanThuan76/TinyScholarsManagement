...
const breadcrumb = {
    items: [
        ...
        {
            key: '/campus',
            title: <Link to="/campus">Danh sách trường học</Link>,
        },
    ],
};
...
const CampusesListPage = () => {
    ...
    const showDeleteConfirmation = (row: Campus) => {
        modal.confirm({
            title: 'Bạn chắc chắn muốn xóa trường học này?',
            icon: <ExclamationCircleOutlined />,
            content: (
                <ProDescriptions column={1} title="Thông tin trường học">
            ...
            onOk: () => {
                return http
                    ...
                    .then(() => {
                        showNotification('Thành công', NotificationType.SUCCESS, 'Trường học đã bị xóa');
    ...
    return (
        <BasePageContainer breadcrumb={breadcrumb}>
            ...
            {modalContextHolder}
            <Drawer
                title={initialValues ? "Cập nhật trường học" : "Tạo mới trường học"}
                width={640}
